...
N = 9; % Index of independent variable
y1 = roomtemp_training(:,1);
u1 = roomtemp_training(:,N);
u1_1 = roomtemp_training(:,4);
u1_2 = roomtemp_training(:,4);
% u1_3 = occupancy_training(:,2);
% u1_4 = occupancy_training(:,5);
y2 = roomtemp_testing(:,1);
u2 = roomtemp_testing(:,N);
u2_1 = roomtemp_testing(:,4);
u2_2 = roomtemp_testing(:,4);
...
%5data_training = iddata(y1,[u1,u1_1],1);
...
% ynew7 = dataFilt.y(3:end);
% save('ynew7.mat','ynew7')